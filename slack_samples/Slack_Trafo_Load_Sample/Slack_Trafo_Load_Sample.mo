...
ModPowerSystems.PhasorSinglePhase.Sources.Slack CIM_SL(Vnom(displayUnit = "V") = 110000.000, f(displayUnit = "Hz") = 50.0, phiV(displayUnit = "rad") = 0.000)
