ModPowerSystems.PhasorSinglePhase.Households.HouseholdType2 {{NAME}}(Household_Vnom = {{Household_Vnom}}, Load_Pnom = {{LOAD_PNOM}}, Load_Qnom = {{LOAD_QNOM}}, Load_ProfileFileName = "{{LOAD_PROFILE_FILENAME}}", Load_ProfileName = "{{LOAD_PROFILE_NAME}}",
