{{#LOADTYPE1_SECTION}}
ModPowerSystems.PhasorSinglePhase.Households.HouseholdType2 {{NAME}}(Household_Vnom = {{HOUSEHOLD_VNOM}}, Load_Pnom = {{LOAD_PNOM}}, Load_Qnom = {{LOAD_QNOM}}, Load_Type = {{LOAD_TYPE}}, PV_Controller = {{PV_CONTROLLER}}, PV_CurtailmentLimit = {{PV_CURTAILMENT_LIMIT}}, PV_Pnom = {{PV_PNOM}}, PV_ProfileFileName = "{{PV_PROFILE_FILENAME}}", PV_ProfileName = "{{PV_PROFILE_NAME}}", PV_SystemOn = {{PV_SYSTEMON}})
{{/LOADTYPE1_SECTION}}
{{#LOADTYPE2_SECTION}}
