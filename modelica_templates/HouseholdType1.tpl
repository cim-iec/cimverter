{{#LOADTYPE1_SECTION}}
ModPowerSystems.PhasorSinglePhase.Households.HouseholdType1 {{NAME}}(Household_Vnom = {{HOUSEHOLD_VNOM}}, Load_Pnom = {{LOAD_PNOM}}, Load_Qnom = {{LOAD_QNOM}}, Load_Type = {{LOAD_TYPE}}) 
{{/LOADTYPE1_SECTION}}
{{#LOADTYPE2_SECTION}}
