ModPowerSystems.SinglePhase.Loads.PQLoad {{NAME}} (Pnom(displayUnit = "{{PNOM_DISPLAYUNIT}}") = {{PNOM}}, Qnom(displayUnit = "{{QNOM_DISPLAYUNIT}}") = {{QNOM}}, Vnom(displayUnit = "{{VNOM_DISPLAYUNIT}}") = {{VNOM}}))
