...
model Slack_Load_Line_Sample
  ...
  PowerSystems.AC3ph.Sources.InfBus infBus(V_nom=20000)
    annotation (Placement(transformation(extent={{-50,-10},{-30,10}})));
  PowerSystems.AC3ph.Loads.PQload pqLoad(V_nom=20000, pq0={330000,205000})
  ...
  PowerSystems.AC3ph.Lines.PIline line1(len=4890, redeclare record Data =
...
equation
  ...
  connect(line1.term_n, bus2.term)
    annotation (Line(points={{10,0},{15,0},{20,0}}, color={0,120,120}));
  connect(line1.term_p, bus1.term)
