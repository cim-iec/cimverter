within ;
model Slack_Trafo_Load_Ground_Sample
...
equation
  ...
  connect(infBus.neutral, grd1.term)
    annotation (Line(points={{-50,0},{-55,0},{-60,0}}, color={0,0,255}));
  annotation (
    uses(PowerSystems(version = "0.7 dev")));
end Slack_Trafo_Load_Ground_Sample;
