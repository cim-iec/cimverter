model modpowersystems_slack_load_line_sample_v3 
...
ModPowerSystems.PhasorSinglePhase.Connections.PiLine CIM_L0(Imax(displayUnit = "A") = 320.000, Sr(displayUnit = "W") = 1.000000, g = 0.000000, length=4.890000, r=0.337000, x=0.358000, b=0.0000511699)
...
end modpowersystems_slack_load_line_sample_v3; 