		...
		namespace SinglePhase {
			...
			namespace Sources {
				...
				public:
					...
					void set_frequency(double frequency){ this->_frequency = frequency; };
					double frequency() const { return _frequency; };

					void set_phiV(double phiV){ this->_phiV = phiV; };
					double phiV() const { return _phiV; };
					...
					void set_frequency_displayUnit(modelicaUnit frequency_displayUnit){ this->_frequency_displayUnit = frequency_displayUnit; };
					modelicaUnit frequency_displayUnit() const { return _frequency_displayUnit; };

					void set_phiV_displayUnit(modelicaUnit phiV_displayUnit){ this->_phiV_displayUnit = phiV_displayUnit; };
					modelicaUnit phiV_displayUnit() const { return _phiV_displayUnit; };
