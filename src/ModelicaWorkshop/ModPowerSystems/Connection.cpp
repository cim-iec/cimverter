...
*/
Connection::Connection(const BusBar* busbar):_port1(busbar->name()),_terminalId1(configManager->cs.BusBarName + "1"),_p1(Point{busbar->annotation.placement.transformation.origin.x,
...
Connection::Connection(const BusBar* busbar, const Slack* slack): Connection(busbar) {
  ...
  _port2 = slack->name();
  _terminalId2 = Connection::configManager->cs.SlackName + "1";
  _port2.append(".");
...
Connection::Connection(const BusBar* busbar, const PQLoad* pq_load): Connection(busbar) {
  ...
  _port2 = pq_load->name();
  _terminalId2 = Connection::configManager->cs.PQLoadName + "1";
  _port2.append(".");
  _port2.append(_terminalId2);
...
Connection::Connection(const BusBar* busbar, const Household* household): Connection(busbar) {
  ...
  _terminalId2 = Connection::configManager->cs.HouseholdName + "1";
  _port2.append(".");
  _port2.append(_terminalId2);
...
Connection::Connection(const BusBar* busbar, const ConnectivityNode* connectivity_node): Connection(busbar) {
  ...
  _terminalId2 = this->configManager->cs.ConnectivityNodeName + "1";
  _port2.append(".");
  _port2.append(_terminalId2);
...
Connection::Connection(const BusBar* busbar, const WindGenerator* wind_generator): Connection(busbar) {
  ...
  _terminalId2 = this->configManager->cs.WindGeneratorName + "1";
  _port2.append(".");
  _port2.append(_terminalId2);
...
Connection::Connection(const BusBar* busbar, const SolarGenerator* solar_generator): Connection(busbar) {
  ...
  _terminalId2 = this->configManager->cs.SolarGeneratorName + "1";
  _port2.append(".");
  _port2.append(_terminalId2);
...
Connection::Connection(const BusBar* busbar, const Battery* battery): Connection(busbar) {
  ...
  _port2 = battery->name();
  _terminalId2 = this->configManager->cs.BatteryName + "1";
  _port2.append(".");
  _port2.append(_terminalId2);
