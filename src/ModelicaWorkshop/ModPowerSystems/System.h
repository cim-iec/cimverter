...
namespace ModPowerSystems {
	...
	public:
		...
		void set_f_nom(double f_nom){ this->_f_nom = f_nom; };
		double f_nom() const { return _f_nom; };

		void set_simMode(std::string simMode){ this->_simMode = simMode; };
		std::string simMode() const { return _simMode; };

		void set_init(std::string init){ this->_init = init; };
		std::string init() const { return _init; };

		void set_f_nom_displayUnit(modelicaUnit f_nom_displayUnit){ this->_f_nom_displayUnit = f_nom_displayUnit; };
		modelicaUnit f_nom_displayUnit() const { return _f_nom_displayUnit; };
