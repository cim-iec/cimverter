...
void Task::print()
{
	std::cout << "Task:: "<<_CIMAttrName << " = " << _Value << std::endl;
}
...
bool assign_WindTurbineType3or4Dynamics_WindTurbineType3or4(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Dynamics::StandardModels::WindDynamics::WindTurbineType3or4Dynamics* element = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindTurbineType3or4Dynamics*>(BaseClass_ptr1))
	{
		element->WindTurbineType3or4 = dynamic_cast<IEC61970::Base::Wires::WindTurbineType3or4*>(BaseClass_ptr2);
		if(element->WindTurbineType3or4 != nullptr)
			return true;
	}
	return false;
}
...
bool assign_WindContPitchAngleIEC_WindGenTurbineType3IEC(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		element->WindGenTurbineType3IEC = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindGenTurbineType3IEC*>(BaseClass_ptr2);
...
{
	if(IEC61970::Dynamics::StandardModels::WindDynamics::WindPitchContEmulIEC* element = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindPitchContEmulIEC*>(BaseClass_ptr1))
	{
...
bool assign_WindAeroConstIEC_WindGenTurbineType1IEC(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		element->WindGenTurbineType1IEC = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindGenTurbineType1IEC*>(BaseClass_ptr2);
...
{
	if(IEC61970::Dynamics::StandardModels::WindDynamics::WindAeroLinearIEC* element = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindAeroLinearIEC*>(BaseClass_ptr1))
	{
		element->WindGenTurbineType3IEC = dynamic_cast<IEC61970::Dynamics::StandardModels::WindDynamics::WindGenTurbineType3IEC*>(BaseClass_ptr2);
		if(element->WindGenTurbineType3IEC != nullptr)
			return true;
...
bool assign_TopologicalNode_ReportingGroup(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	...
	{
		element->ReportingGroup = dynamic_cast<IEC61970::Base::Core::ReportingGroup*>(BaseClass_ptr2);
...
bool assign_EnergySourcePhase_EnergySource(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Wires::EnergySourcePhase* element = dynamic_cast<IEC61970::Base::Wires::EnergySourcePhase*>(BaseClass_ptr1))
	{
...
{
	if(IEC61970::Base::Core::ReportingGroup* element = dynamic_cast<IEC61970::Base::Core::ReportingGroup*>(BaseClass_ptr1))
	{
...
bool assign_ReportingSuperGroup_ReportingGroup(BaseClass* BaseClass_ptr1, BaseClass* BaseClass_ptr2)
{
	if(IEC61970::Base::Core::ReportingSuperGroup* element = dynamic_cast<IEC61970::Base::Core::ReportingSuperGroup*>(BaseClass_ptr1))
	{
		if(dynamic_cast<IEC61970::Base::Core::ReportingGroup*>(BaseClass_ptr2) != nullptr)
		{
			element->ReportingGroup.push_back(dynamic_cast<IEC61970::Base::Core::ReportingGroup*>(BaseClass_ptr2));
			return true;
		}
	}
	return false;
...
static std::unordered_map<std::string, bool (*)(BaseClass*, BaseClass*)> initialize()
{
	...
	map.insert(std::make_pair("cim:WindTurbineType3or4Dynamics.WindTurbineType3or4", &assign_WindTurbineType3or4Dynamics_WindTurbineType3or4));
	map.insert(std::make_pair("cim:WindTurbineType3or4.WindTurbineType3or4Dynamics", &assign_WindTurbineType3or4Dynamics_WindTurbineType3or4));
	map.insert(std::make_pair("cim:WindContPitchAngleIEC.WindGenTurbineType3IEC", &assign_WindContPitchAngleIEC_WindGenTurbineType3IEC));
	...
	map.insert(std::make_pair("cim:WindPitchContEmulIEC.WindGenTurbineType2IEC", &assign_WindPitchContEmulIEC_WindGenTurbineType2IEC));
	map.insert(std::make_pair("cim:WindGenTurbineType2IEC.WindPitchContEmulIEC", &assign_WindPitchContEmulIEC_WindGenTurbineType2IEC));
	...
	map.insert(std::make_pair("cim:WindContPType3IEC.WindGenTurbineType3IEC", &assign_WindContPType3IEC_WindGenTurbineType3IEC));
	map.insert(std::make_pair("cim:WindGenTurbineType3IEC.WindContPType3IEC", &assign_WindContPType3IEC_WindGenTurbineType3IEC));
	map.insert(std::make_pair("cim:WindAeroConstIEC.WindGenTurbineType1IEC", &assign_WindAeroConstIEC_WindGenTurbineType1IEC));
	map.insert(std::make_pair("cim:WindGenTurbineType1IEC.WindAeroConstIEC", &assign_WindAeroConstIEC_WindGenTurbineType1IEC));
	...
	map.insert(std::make_pair("cim:WindMechIEC.WindGenTurbineType3IEC", &assign_WindMechIEC_WindGenTurbineType3IEC));
	map.insert(std::make_pair("cim:WindGenTurbineType3IEC.WindMechIEC", &assign_WindMechIEC_WindGenTurbineType3IEC));
	...
	map.insert(std::make_pair("cim:WindAeroLinearIEC.WindGenTurbineType3IEC", &assign_WindAeroLinearIEC_WindGenTurbineType3IEC));
	map.insert(std::make_pair("cim:WindGenTurbineType3IEC.WindAeroLinearIEC", &assign_WindAeroLinearIEC_WindGenTurbineType3IEC));
	...
	map.insert(std::make_pair("cim:EnergySourcePhase.EnergySource", &assign_EnergySourcePhase_EnergySource));
	...
	map.insert(std::make_pair("cim:IdentifiedObject.DiagramObject", &assign_IdentifiedObject_DiagramObjects));
	...
	map.insert(std::make_pair("cim:EquipmentContainer.Equipment", &assign_EquipmentContainer_Equipments));
	...
	map.insert(std::make_pair("cim:Substation.VoltageLevel", &assign_Substation_VoltageLevels));
	...
	map.insert(std::make_pair("cim:ReportingSuperGroup.ReportingGroup", &assign_ReportingSuperGroup_ReportingGroup));
	map.insert(std::make_pair("cim:ReportingGroup.ReportingSuperGroup", &assign_ReportingSuperGroup_ReportingGroup));
	...
	map.insert(std::make_pair("cim:Region.Substation", &assign_SubGeographicalRegion_Substations));
	...
	map.insert(std::make_pair("cim:Region.SubGeographicalRegion", &assign_GeographicalRegion_Regions));
	...
	map.insert(std::make_pair("cim:DiagramObject.DiagramObjectPoint", &assign_DiagramObject_DiagramObjectPoints));
	...
	map.insert(std::make_pair("cim:OperationalLimitSet.OperationalLimit", &assign_OperationalLimitSet_OperationalLimitValue));
