...
class CIMObjectHandler {
 ...
 public:
  ...
  PVNode GeneratingUnitHandler(const TPNodePtr tp_node, const TerminalPtr terminal, const GeneratingUnitPtr generatingUnitPtr, ctemplate::TemplateDictionary* dict);
