...
annotation (Placement(visible = true, transformation(extent = {{-5.0,-5.0},{5.0,5.0}}, rotation = 0, origin = {130.9,-19.2})));
...
ModPowerSystems.PhasorSinglePhase.Connections.PiLine CIM_L12_13(Imax(displayUnit = "A") = 320.000, Sr(displayUnit = "W") = 1.000000, g = 0.000000, length=0.004890, r=337.000001, x=358.000001, b=0.0511699388)
annotation (Placement(visible = true, transformation(extent = {{-8.0,-8.0},{8.0,8.0}}, rotation = -90, origin = {222.8,-118.0})));
ModPowerSystems.PhasorSinglePhase.Transformers.Transformer CIM_TR2(Vnom1 = 110000.000, Vnom2 = 20000.000, Sr(displayUnit = "W") = 40000000.000, URr = 0.63000, Ukr = 12.04000, TapPos = 0.000000, TapStep = 0.100000)
