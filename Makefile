...
# Objects
OBJ = $(OBJDIR)/main.o $(OBJDIR)/task.o $(OBJDIR)/CIMParser.o $(OBJDIR)/CIMFactory.o $(OBJDIR)/assignments.o $(OBJDIR)/CIMObjectHandler.o \
	  $(OBJDIR)/ModBaseClass.o $(OBJDIR)/Connection.o $(OBJDIR)/System.o $(OBJDIR)/Slack.o \
	  $(OBJDIR)/Transformer.o $(OBJDIR)/BusBar.o $(OBJDIR)/ConnectivityNode.o $(OBJDIR)/PQLoad.o $(OBJDIR)/PiLine.o $(OBJDIR)/RxLine.o $(OBJDIR)/ZLoad.o $(OBJDIR)/GenericGenerator.o
