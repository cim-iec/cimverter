ModPowerSystems.SinglePhase.Households.HouseholdType2 {{NAME}}(Load_Pnom = {{LOAD_PNOM}}, Load_Qnom = {{LOAD_QNOM}}, Load_ProfileFileName = "{{LOAD_PROFILE_FILENAME}}", Load_ProfileName = "{{LOAD_PROFILE_NAME}}",
